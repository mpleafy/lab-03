...
fun CityListScreen(
    cities: List<City>,
    onAddCity: (City) -> Unit,
    onUpdateCity: (String, String, City) -> Unit,
        ...
        if (showUpdateCityFields) {
            Row(
                ...
                Button(
                    ...
                    onClick = {
                        if (newCityName.isNotBlank() && newProvinceName.isNotBlank() && oldCityName.isNotBlank() && oldProvinceName.isNotBlank()) {
                            onUpdateCity(
                                oldCityName,
                                oldProvinceName,
                                City(
